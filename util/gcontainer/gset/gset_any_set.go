...
// AddIfNotExist checks whether battle exists in the set,
// it adds the battle to set and returns true if it does not exists in the set,
// or else it does nothing and returns false.
//
// Note that, if <battle> is nil, it does nothing and returns false.
...
// AddIfNotExistFunc checks whether battle exists in the set,
// it adds the battle to set and returns true if it does not exists in the set and
// function <f> returns true, or else it does nothing and returns false.
//
// Note that, if <battle> is nil, it does nothing and returns false. The function <f>
...
// Contains checks whether the set contains <battle>.
...
// Remove deletes <battle> from set.
...
// Pops randomly pops an battle from set.
...
// Walk applies a user supplied function <f> to every battle of set.
